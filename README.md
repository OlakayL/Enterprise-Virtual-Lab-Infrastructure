...
## Network Topology
      ...
      │                       │            │                       │
┌─────┴────────────────┐ ┌────┴────────────┴┐ ┌────────────────────┴┐
│   DC01 (Win Server)  │ │ Admin Workstation│ │  WIN10-01 (Client)  │
│ IP:  192.168.10.10   │ │ IP: 192.168.10.50│ │ IP:  192.168.20.50  │
│ GW:  192.168.10.1    │ │ GW: 192.168.10.1 │ │ GW:  192.168.20.1   │
│ DNS: 127.0.0.1       │ │ DNS:192.168.10.10│ │ DNS: 192.168.10.10  │
└──────────────────────┘ └──────────────────┘ └─────────────────────┘
